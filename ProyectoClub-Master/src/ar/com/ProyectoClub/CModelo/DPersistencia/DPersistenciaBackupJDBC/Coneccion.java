 ...
 */
package ar.com.ProyectoClub.CModelo.DPersistencia.DPersistenciaBackupJDBC;
...
public class Coneccion {
    ...
    public final void Conectar() {
        try {
            ...
            conexion = (Connection) DriverManager.getConnection("jdbc:mysql://" + "" + "localhost" + "/" + "mysql", "root", "cris709");
            error="NO";
